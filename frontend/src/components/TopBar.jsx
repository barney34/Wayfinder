...
export function TopBar({ customerName, opportunity, onNameChange, onOpportunityChange, onNameBlur, onOpportunityBlur }) {
  ...
  return (
    <div className="flex-shrink-0 bg-[#1c1c1e] border-b border-[#2c2c2e]" data-testid="topbar">
      {/* Single shared grid — both rows use the same column tracks */}
      <div className="px-4 grid gap-x-3" style={{ gridTemplateColumns: '5fr 5fr 3fr 3fr' }}>

        {/* === ROW 1: Summary header — spans the grid columns === */}
        {/* Cell 1: Customer pill (left-aligned, overlaps DC column) */}
        <div 
          className="py-1.5 flex items-center border-b border-[#2c2c2e] cursor-pointer"
        ...
        {/* Cell 2: Sites summary — centered */}
        <div 
          className="py-1.5 flex items-center justify-center gap-3 border-b border-[#2c2c2e] cursor-pointer"
          onClick={() => setCollapsed(!collapsed)}
        >
          <div className="flex items-center gap-1.5">
        ...
        {/* Cell 3: TS summary — stacked 2x2, centered */}
        <div 
          className="py-1.5 flex flex-col items-center justify-center gap-0.5 border-b border-[#2c2c2e] cursor-pointer"
          onClick={() => setCollapsed(!collapsed)}
        >
        ...
        {/* Cell 4: KW + IPs + Chevron */}
        <div 
          className="py-1.5 flex items-center justify-center gap-2 border-b border-[#2c2c2e] cursor-pointer"
          onClick={() => setCollapsed(!collapsed)}
        >
          <div className="flex items-center gap-1">
