                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div className="bg-destructive/10 rounded-lg p-3 border border-destructive/30">
                      ...
                      <ul className="space-y-1">
                        {category.before_scenarios.map((scenario, i) => (
                          <li key={i} className="text-xs text-red-800/80 dark:text-red-200/80 flex items-start gap-1.5">
                    ...
                    <div className="bg-green-50/50 dark:bg-green-900/10 rounded-lg p-3 border border-green-200/50 dark:border-green-800/30">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs font-semibold text-green-700 dark:text-green-300 uppercase tracking-wide">How Infoblox Solves This</span>
                      </div>
                      <ul className="space-y-1">
                        {category.infoblox_solves.map((solution, i) => (
                          <li key={i} className="text-xs text-green-800/80 dark:text-green-200/80 flex items-start gap-1.5">
